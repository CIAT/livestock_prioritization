...
class_hazards_fun<-function(classes,haz_names,folder,haz_class,BaseRaster,scenario,time_period){
    names(classes)<-haz_names
    data<-lapply(haz_names,FUN=function(hazard){
...
classes<-reactive({
  c(input$Hazards.NDD,
    input$Hazards.NTx40,
    input$Hazards.HSM_NTx35,
    input$Hazards.HSH_max,
    input$Hazards.THI_max,
    input$Hazards.NDWS,
    input$Hazards.TAI,
    input$Hazards.NDWL0)
})
